      ...
      <div class="Destacados container-fluid">
            <div class="row row-cols-1 row-cols-md-3">
                <div class="card col-12 col-sm-6 col-md-4" style="width: 18rem;">
                  <img class="card-img-top" src="https://assets1.ignimgs.com/2019/01/16/mortalkombat-7mins-blogroll-1-1547679583972.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Nueva pelicula de MK</h5>
                    <p class="card-text">Mortal Kombat Still Expected to Open in Theaters, But Tom & Jerry Could Get HBO Max Hybrid Release</p>
                    <a href="noticiaEspecifica.jsp" class="btn btn-primary">Detalles</a>
                  </div>
                </div>  
                <div class="card col-12 col-sm-6 col-md-4" style="width: 18rem;">
                  <img class="card-img-top" src="https://assets1.ignimgs.com/2020/03/16/ign-best-dramas-netflix-blogroll-a-1584402970907.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Netflix</h5>
                    <p class="card-text">Best Drama Movies on Netflix Right Now (December 2020)</p>
                    <a href="noticiaEspecifica.jsp" class="btn btn-primary">Detalles</a>
                  </div>
                </div>  
                <div class="card col-12 col-sm-6 col-md-4" style="width: 18rem;">
                  <img class="card-img-top" src="https://assets1.ignimgs.com/2020/12/02/beyond678ign-1606949808556.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Sony</h5>
                    <p class="card-text">PS5: Why Single-Player Games Are Integral to Sony's Next-Gen Console</p>
                    <a href="noticiaEspecifica.jsp" class="btn btn-primary">Detalles</a>
                  </div>
                </div>  
            </div>
